...
from physirox.services.scene import SceneEventBus, SceneEventType, SceneEvent
...
class _SceneviewerTestBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._patches = [
            ...
            patch('physirox.tasks.sceneviewer.SceneRunnerService'),
            # SceneViewerFrame
            patch('physirox.tasks.sceneviewer.SceneViewerFrame'),
            # EnvironmentService
            patch('physirox.tasks.sceneviewer.EnvironmentService'),
            ...
            patch('physirox.tasks.sceneviewer.QMenu'),
        ]
    ...
    def _make_task(self):
        from physirox.tasks.sceneviewer import SceneviewerApplicationTask
...
class TestEnableMenuEntries(_SceneviewerTestBase):
    ...
    def test_enable_true_calls_enable_by_owner(self):
        ...
        from physirox.services.scene import SceneEvent, SceneEventType
        task = self._make_task()
...
class TestSceneviewerFactoryRegistration(unittest.TestCase):
    ...
    def test_registered_in_application_task_factory(self):
        ...
        import physirox.tasks.sceneviewer
        ...
        importlib.reload(physirox.tasks.sceneviewer)
    ...
    def test_is_subclass_of_application_task(self):
        ...
        self.assertTrue(
            issubclass(
                physirox.tasks.sceneviewer.SceneviewerApplicationTask,
