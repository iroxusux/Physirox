...
from physirox.interfaces import ICompositeSceneObject, ISceneObject, IPhysicsBody2D
from physirox.services.scene import (
    SceneRunnerService,
    SceneEventBus,
    SceneEventType,
    SceneEvent
)
from physirox.services.physics import PhysicsEngineService
from physirox.services.environment import EnvironmentService
...
class TestSceneRunnerService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Patch GuiManager where it is used in scene.py
        self.gui_manager_patcher = patch('physirox.services.scene.GuiManager')
    ...
    @patch('physirox.services.scene.datetime')
    ...
    def test_new_scene_creates_and_sets_scene(self):
        ...
        with patch('physirox.models.scene.Scene') as MockScene:
...
class TestSceneRunnerServiceFilepath(unittest.TestCase):
    ...
    def test_save_scene_quick_save_uses_stored_filepath(self):
        ...
        try:
            ...
            with patch('physirox.services.scene.get_save_file') as mock_dialog:
    ...
    def test_save_scene_without_filepath_opens_dialog_when_unknown(self):
        ...
        with patch('physirox.services.scene.get_save_file', return_value=None) as mock_dialog:
...
class TestViewportStatusServiceLifecycle(unittest.TestCase):
    ...
    def setUp(self):
        from physirox.services.viewport import ViewportEventBus
    ...
    def test_subscribes_to_all_three_event_types_on_init(self):
        ...
        from physirox.services.viewport import ViewportStatusService, ViewportEventBus, ViewportEventType
    ...
    def test_destroy_is_safe_to_call_twice(self):
        ...
        from physirox.services.viewport import ViewportStatusService
        svc = ViewportStatusService()
        svc.destroy()
...
class TestViewportHostingServiceLifecycle(unittest.TestCase):
    ...
    def _make_hosting_service(self):
        ...
        from physirox.services.viewport import ViewportHostingService
        with patch('physirox.services.viewport.ViewportStatusService.build', return_value=None):
    ...
    def test_hosting_service_registers_subscriptions_on_init(self):
        ...
        from physirox.services.viewport import ViewportEventBus, ViewportEventType
...
class TestSceneBridgeServiceLifecycle(unittest.TestCase):
    ...
    def setUp(self):
        SceneEventBus.clear()
        from physirox.services.scene import SceneBridgeService
