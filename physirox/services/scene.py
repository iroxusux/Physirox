    ...
    * **SCENE_SAVED** — no action needed; bridge config is embedded in the
    ...
    def register_source_factory(
        ...
        if cls._bridge is not None:
            from physirox.models.scene.sceneboundlayer import SceneBoundLayer
    ...
    def new_bridge(cls, scene: IScene | None) -> None:
        ...
        from physirox.models.scene.scenebridge import SceneBridge
        from physirox.models.scene.sceneboundlayer import SceneBoundLayer
...
class SceneRunnerService(
    ...
    _environment: environment.EnvironmentService | None = None
    ...
    def initialize(
        ...
        env: environment.EnvironmentService | None = None,
        ...
        # Physics integration
        if enable_physics:
            cls.set_environment(env or environment.EnvironmentService())
    ...
    def new_scene(cls) -> None:
        ...
        """
        from physirox.models.scene import Scene
        scene = Scene()
    ...
    @classmethod
    def get_environment(cls) -> environment.EnvironmentService | None:
    ...
    @classmethod
    def set_environment(cls, env: environment.EnvironmentService | None) -> None:  # type: ignore
