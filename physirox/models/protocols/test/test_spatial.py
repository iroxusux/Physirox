...
from physirox.interfaces import CardinalDirection, IDirectional2D, IRotatable
from physirox.models.protocols.spatial import (
    Rotatable,
    Spatial2D,
    Zoomable,
)
from physirox.models.protocols.coord import (
    Area2D,
)
