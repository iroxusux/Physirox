...
# ---------------------------------------------------------------------------
from physirox.models.gui.sceneviewer.sceneviewer import (  # noqa: E402
    SceneViewerFrame,
    _SceneCanvasView,
)
from physirox.models.gui.sceneviewer._user_mode import UserMode  # noqa: E402
...
# resolve correctly.
import physirox.models.gui.sceneviewer.sceneviewer as _sv_module  # noqa: E402
_sv_module.Qt = _Qt
...
class TestCanvasViewMouseMove(unittest.TestCase):
    ...
    def test_middle_drag_pans_viewport(self):
        ...
        with patch("physirox.models.gui.sceneviewer.sceneviewer.ViewportEventBus"):
...
def _make_real_physics_body(name: str = "body",
    ...
    from physirox.models import BasePhysicsBody
    from physirox.interfaces import BodyType, ColliderType, CollisionLayer
...
def _make_real_composite(name: str = "Panel",
    ...
    from physirox.models.scene.compositesceneobject import CompositeSceneObject
...
def _make_real_composite_with_component(comp_w: float = 20.0,
    ...
    from physirox.models import SceneObject
...
class TestCompositeRotationDirection(unittest.TestCase):
    ...
    def test_cw_rotation_north_to_east(self):
        from physirox.interfaces import CardinalDirection
...
class TestCompositeBoundingBoxAlignment(unittest.TestCase):
    ...
    def _get_bbox_item(self, frame, composite, obj_id: str = "c"):
        ...
        ``setZValue``.
        """
        import physirox.models.gui.sceneviewer.sceneviewer as _sv
