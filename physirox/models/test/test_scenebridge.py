...
from physirox.interfaces import IScene
from physirox.models.scene.scenebridge import (
    BindingDirection,
    SceneBinding,
    SceneBridge,
)
...
class TestSceneBridgeIsISceneBridge(unittest.TestCase):
    ...
    def test_scene_bridge_inherits_iscenebridge(self):
        from physirox.interfaces.scene.scenebridge import ISceneBridge
        self.assertTrue(issubclass(SceneBridge, ISceneBridge))

    def test_scene_binding_satisfies_iscenebinding_protocol(self):
        from physirox.interfaces.scene.scenebridge import ISceneBinding
        binding = SceneBinding(
            binding_key="k",
            object_id="o",
            property_path="p",
