...
from physirox.interfaces import BodyType, CardinalDirection, CollisionLayer
...
from physirox.models.scene.assets.topdown._compkinemetic import (
...
class TestCompositeKinematicGetCompositeBodyFromDict(unittest.TestCase):
    ...
    def test_returns_physics_body_for_valid_dict(self):
        from physirox.models.physics import BasePhysicsBody
