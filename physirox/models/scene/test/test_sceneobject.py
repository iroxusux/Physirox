...
class TestSceneObjectAnimator(unittest.TestCase):
    ...
    def _gate_clip(self, mode=None):
        from physirox.models.scene.animation import AnimationClip, AnimationMode, AnimationTrack, AnimationEasing
    ...
    def test_update_at_full_duration_stops_once_clip(self):
        from physirox.models.scene.animation import AnimationMode
        obj = self._make()
    ...
    def test_piston_ping_pong_returns_to_origin(self):
        from physirox.models.scene.animation import AnimationClip, AnimationMode, AnimationTrack
